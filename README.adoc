...
== Single Sign-On
With Single Sign-On enabled members of your organization with access to the EMnify portal will be able to login using their Micosoft Business account credentials.

=== Setup SSO with Microsoft Active Directory
*Prerequisites:*

* An Azure Subscription with an Active Direcotry license
