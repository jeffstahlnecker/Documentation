...
Before you begin the production of your IoT solution with your EMnify SIM cards, you may want to test the service. You can order your free Evaluation SIM package on the EMnify portal with which you can test all EMnify services. Shipping costs may apply for the 3 physical SIM cards, depending on your location. On the other hand you can download the eSIM for your smartphone for free. 
...
When setting up an Android device with an EMnify IoT SIM, you need to follow these 4 steps
...
[.float-group]
--
image::Android_01_Settings.jpg[400,200, float="left", align="center"]
