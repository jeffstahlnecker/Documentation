...
You can order your free Evaluation SIM package on the EMnify Portal with which you can test all EMnify services. The 3 physical SIM cards can be delivered already at no charge to many destinations, for some we have to charge a small shipment fee.
